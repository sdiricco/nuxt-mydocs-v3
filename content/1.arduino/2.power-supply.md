---
title: Come alimentare Arduino
description: Arduino power supply
icon: 'iconoir:page'
---

Puoi alimentare Arduino con il connettore DC con una tensione nel range `6-20V`

![](/images/1.arduino/Pinout-UNOrev3_latest-4.png)
...
![](/images/1.arduino/Pinout-UNOrev3_latest-3.png)

Puoi alimentare Arduino *manualmente* attraverso il pin `Vin` con una tensione esatta di `5V`.

![](/images/1.arduino/Pinout-UNOrev3_latest-1.png)
